            ...
            if _G.DomadicAutoDriveBoat then
                ...
                if not enemies:FindFirstChild("Shark") or not enemies:FindFirstChild("Terrorshark") or not enemies:FindFirstChild("Piranha") or not enemies:FindFirstChild("Fish Crew Member") then
                    ...
                    elseif not game.Players.LocalPlayer.Character.Humanoid.Sit then
                        TPP(pirateBrigade.VehicleSeat.CFrame * CFrame.new(0,1,0))
                    else
                        for i,v in pairs(boats:GetChildren()) do
                            if v.Name == "PirateBrigade" then
                                ...
                                until enemies:FindFirstChild("Shark") or enemies:FindFirstChild("Terrorshark") or enemies:FindFirstChild("Piranha") or enemies:FindFirstChild("Fish Crew Member") or not _G.DomadicAutoDriveBoat
                            end
                        end
                    end
                end
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.DomadicAutoDriveBoat then
                if enemies:FindFirstChild("Shark") or enemies:FindFirstChild("Terrorshark") or enemies:FindFirstChild("Piranha") or enemies:FindFirstChild("Fish Crew Member") then
                    game.Players.LocalPlayer.Character.Humanoid.Sit = false
                end
            end
        end
